    ...
    [ActionStageInstance() dispatchOnStageQueue:^
    {
        ...
        if (_datacenters.size() == 0)
        {
            if (TGAppDelegateInstance.useDifferentBackend)
            {
                ...
                datacenter2.addressSet = [[NSArray alloc] initWithObjects:[[NSDictionary alloc] initWithObjectsAndKeys:@"109.239.131.193", @"address", [[NSNumber alloc] initWithInt:443], @"port", nil], nil];
            ...
            else
            {
                ...
                TGDatacenterContext *datacenter2 = [[TGDatacenterContext alloc] init];
                datacenter2.datacenterId = 2;
                datacenter2.addressSet = [[NSArray alloc] initWithObjects:[[NSDictionary alloc] initWithObjectsAndKeys:@"109.239.131.195", @"address", [[NSNumber alloc] initWithInt:443], @"port", nil], nil];
                _datacenters[datacenter2.datacenterId] = datacenter2;
