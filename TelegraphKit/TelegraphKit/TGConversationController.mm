...
#define TG_MEASURE_CONTROLLER 0
    ...
    _inputContainer = [[TGConversationInputContainerView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - _baseInputContainerHeight, self.view.frame.size.width, _baseInputContainerHeight)];
